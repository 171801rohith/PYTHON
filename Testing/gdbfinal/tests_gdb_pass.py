...
def test_acount_equality():
    a1 = Account("rohith", 1000.0, 123, "GOLD")
    a2 = Account("rohith", 1000.0, 123, "GOLD")
...
def test_transaction_log_equality():
    ...
    assert t1.transaction_log == t2.transaction_log

def test_user_equalities():
    u1 = User(123, "rohith", "234", "active")
    u2 = User(123, "rohith", "234", "active")
...
def test_log_transaction():
    ...
    TransactionManager.log_transaction(12345, 100.0, "transfer")
